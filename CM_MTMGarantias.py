...
list_disagio = []
list_ok = []
dflista = pd.read_csv(r'Q:\CM_MTM\IBXX.csv',index_col = False,sep=';', encoding='latin-1',names= [ 'Codigo',1,2,3,4,5])
df = pd.read_csv(r'Q:\MTM_export\MaximumTheoreticalMargin.csv', sep=';',index_col = False, names= [ 'MTM', 'Data', 'Minima', 'Maxima', 'Minima2', 'Ticker',"AUX"])
...
dfListaGarantia = pd.read_excel(r'Q:\CM_MTM\Aceitagarantia.xlsx',index_col = False)
...
dfl.round(2).to_excel(r'Q:\CM_MTM\Valor Minimo em Garantia.xlsx', sheet_name='MTM', index=False)
# %%
today=date.today()
...
anexo = r'Q:\CM_MTM\Valor Minimo em Garantia.xlsx'
